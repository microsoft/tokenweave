...
def plot_graphs(data, gpu_count, models, graph_title, outdir):
    ...
    pdf_path = os.path.join(outdir, f'figure_11.pdf')
...
def main():
    ...
    outdir = sys.argv[2]
    csvdir = sys.argv[3]
    data_path = os.path.join(indir, 'figure_11_summary.csv')
    ...
    all_filtered_8.to_csv(os.path.join(csvdir, 'figure_11.csv'), index=False)
