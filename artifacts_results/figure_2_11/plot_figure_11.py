...
def main():
    ...
    for model in ["Llama-3.3-70B-Instruct", "Qwen2.5-72B-Instruct", "Mixtral-8x22B-Instruct-v0.1"]:
        ...
        filtered_data.to_csv(os.path.join(csvdir, f'figure_11a.csv'), index=False)
    plot_graphs(data, 8, ["Llama-3.3-70B-Instruct", "Qwen2.5-72B-Instruct", "Mixtral-8x22B-Instruct-v0.1"], 'Prefill (8x H100)', outdir)
    ...
    for model in ["Llama-3.3-70B-Instruct", "Qwen2.5-72B-Instruct"]:
        ...
        filtered_data.to_csv(os.path.join(csvdir, f'figure_11b.csv'), index=False)
    plot_graphs(data, 4, ["Llama-3.3-70B-Instruct", "Qwen2.5-72B-Instruct"], 'Prefill (4x H100)', outdir)
